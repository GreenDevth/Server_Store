        ...
        await ctx.send(
            ...
            components=[
                [
                    ...
                    Button(style=ButtonStyle.gray, label='FIRST PURCHASE CLICK', emoji='🏷', id='atv_blue'),
                ]
            ]
        )
        await ctx.send(
            ...
            components=[
                [
                    ...
                    Button(style=ButtonStyle.gray, label='FIRST PURCHASE CLICK', emoji='🏷', id='atv_camo'),
                ]
            ]
        )
        await ctx.send(
            ...
            components=[
                [
                    ...
                    Button(style=ButtonStyle.gray, label='FIRST PURCHASE CLICK', emoji='🏷', id='atv_red'),
                ]
            ]
        )
        ...
        await ctx.send(
            ...
            components=[
                [
                    ...
                    Button(style=ButtonStyle.gray, label='FIRST PURCHASE CLICK', emoji='🏷', id='atv_yellow'),
                ]
            ]
        )
